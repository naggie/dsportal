...
async def tab_handler(request):
    ...
    return {
        ...
        "percent_healthy": round(len(index.healthy_healthchecks)*100/len(index.healthchecks),3),
        "percent_unhealthy": round(len(index.unhealthy_healthchecks)*100/len(index.healthchecks),3),
